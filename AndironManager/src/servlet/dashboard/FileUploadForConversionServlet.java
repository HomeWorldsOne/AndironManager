...
import dto.FileLocatorForConversion;
import dto.ConvertedFileForConversion;

import dao.FileLocatorForConversionDAO;
import dao.ConvertedFileForConversionDAO;

public class FileUploadForConversionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//List<FileLocatorForConversion> files = FileLocatorDAO.selectAll();
		...
		//Create files for webpage
		//List<ConvertedFileForConversion> convertedFiles = ConvertedFileDAO.selectAll();
		...
		//intitiate request
		RequestDispatcher rd = request.getRequestDispatcher("WorkSpace/Dashboard/fileConverter.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while (fileItemsIterator.hasNext()) {
				...
				String path = request.getServletContext().getAttribute("FILES_DIR") + "Files\\Conversion\\" + fileItem.getName();
